                            ...
                            <div class="input-group mb-3">
                                <div class="col-md-2" style="padding-left:0;margin-top: 12px;">
                                    @if (!empty($invoice->shop_photo))
                                        <img id="favicon" src="{{URL::to('images/'.$invoice->shop_photo)}}" style="width:50px; height:50px;border: 1px solid #000000">
                                    @else
                                        <img id="favicon" src="{{asset('images/imguploadicon.svg')}}" style="width:50px; height:50px;border: 1px solid #000000">
                                    @endif
                                </div>
