                        ...
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="{{URL::to('public/images/'.$row->product->photo)}}" style="width: 60px; height: 60px">
                                    @else
                                    <img src="{{URL::to('public/images/imguploadicon.svg')}}" style="width: 60px; height: 60px">
                                    @endif
                                </td>
                                <td>{{$row->quantity}}</td>
                                <td>{{$row->buy_price}}</td>
