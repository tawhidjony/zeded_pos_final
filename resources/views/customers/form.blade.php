...
<!-- Start -->
<div class="form-group row">
    <label for="name" class="col-md-3  col-form-label text-md-left">{{ __('About :') }}</label>
    <div class="col-md-9">
        <textarea type="text" class="form-control{{ $errors->has('about') ? ' is-invalid' : '' }}" name="about"

                  autofocus>@if($customer->about){{$customer->about}}@else{{ old('about') }}@endif</textarea>
