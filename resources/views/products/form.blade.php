    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <select id="inputState" type="text" class="form-control" name="sub_category_id" >
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <select id="inputState" type="text" class="form-control" name="brand_id">
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            <select id="inputState" type="text" class="form-control" name="pro_model_id">
    ...
    <div class="col-sm-6">
        <div class="input-group mb-3">
            ...
            @if (!empty($product->photo))
                 <img id="image" src="{{URL::to('images/'.$product->photo)}}" style="width: 100px; height: 100px;" >
            @else
                <img id="image" src="{{asset('images/imguploadicon.svg')}}" style="width: 100px; height:100px; margin-left:10px;" >
            @endif
