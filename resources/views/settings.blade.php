                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="col-md-2" style="padding-left:10;margin-top: 17px;">
                                    @php
                                        ...
                                        if ($favicon){ 
                                            echo '<img id="favicon" src="'.URL::to('images/'.$favicon).'" style="width:50px; height:50px;border: 1px solid #000000">';
                                        }else{
                                            echo '<img id="favicon" src="'.asset('images/imguploadicon.svg').'" style="width:50px; height:50px;border: 1px solid #000000">';
                                        }
                                    @endphp
                                </div>
                            </div>
